...
namespace CountryApp.Controllers
{
    public class CityController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="Id,Name,About,NoOfDwellers,Location,Weather,CountryId")] City city)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="Id,Name,About,NoOfDwellers,Location,Weather,CountryId")] City city)
        {
            if (ModelState.IsValid)
            {
